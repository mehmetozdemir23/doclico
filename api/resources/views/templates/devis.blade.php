...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── Footer ── */
        .footer { margin-top: 1.2cm; font-size: 7.5pt; color: #9ca3af; border-top: 1px solid #f3f4f6; padding-top: 0.4cm; line-height: 1.7; }

        /* ── Signature ── */
        .signature-block { margin-top: 1.5cm; display: table; width: 100%; }
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="doc-meta">
                N° {{ $data['numero_devis'] ?? '' }}<br>
                {{ $dateDevis }}
                @if(!empty($data['validite']))<br>Validité : {{ $data['validite'] }}@endif
            </div>
        </div>
    </div>

    <div class="client-block">
        <div class="client-tag">Adressé à</div>
    ...
    <div class="footer">
        ...
        Ce devis est valable {{ !empty($data['validite']) ? $data['validite'] : '30 jours' }} à compter de sa date d'émission.
